...
export default function DashboardPostsEdit() {
    ...
    return (
        <>
            <h1 className="poppins-700">Editácia postu</h1>
            <div className="mt-4 px-2">
                <Form method="post">
                    ...
                    <button name="save" className="py-1 mt-3 px-4 bg-indigo-500 rounded-md text-indigo-100 poppins hover:bg-indigo-600 hover:text-indigo-200 hover:shadow-sm hover:shadow-indigo-600/50 transition-all duration-200 text-[15px]">Uložiť</button>
                    <button name="delete" className="py-1 mt-3 px-4 bg-indigo-500 rounded-md text-indigo-100 poppins hover:bg-indigo-600 hover:text-indigo-200 hover:shadow-sm hover:shadow-indigo-600/50 transition-all duration-200 text-[15px] ml-2">Zmazať</button>
                </Form>
            </div>
        </>
    );
